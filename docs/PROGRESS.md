...
| 2 | Hot-path data layer: Postgres schema, AI Search indexes, single-document ingestion | pending |
| 3 | Retrieval layer: hybrid query client, FAISS/BM25 removal with eval comparison | pending |
| 4 | Agent layer: LLM wrapper, LangGraph graph, versioned prompts, Langfuse | pending |
